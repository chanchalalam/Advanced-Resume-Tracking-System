...
if uploaded_file is None:
    ...
    st.markdown("Chanchal Alam")
    col1, col2, col3 = st.columns([1,1,1])
    with col1:
        st.link_button("Linkdin", "https://www.linkedin.com/in/chanchalalam786")
    with col2:
        st.link_button("Github", "https://github.com/chanchalalam")
    with col3:
        st.link_button("Kaggle", "https://www.kaggle.com/chanchal24")
    st.markdown("---")
